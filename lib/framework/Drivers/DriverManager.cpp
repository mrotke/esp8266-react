...
DriverManager::DriverManager(AsyncWebServer* server, FS* fs):
m_server(server),
m_FS(fs),
_httpEndpoint(DriverManagerSettings::read, DriverManagerSettings::update, this, server, "/rest/driverManager"),
_FSPersistance(DriverManagerSettings::read, DriverManagerSettings::update, this, fs, "drivermanager.json")
{
